...
public class EditorActivity extends AppCompatActivity implements
     ...
     * {@link ProductContract.ProductEntry#GENDER_UNKNOWN}, {@link ProductEntry#GENDER_MALE}, or
    ...
    private void setupSpinner() {
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = ProductContract.ProductEntry.GENDER_MALE;
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = ProductContract.ProductEntry.GENDER_FEMALE;
                    } else {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                mGender = ProductEntry.GENDER_UNKNOWN;
            }
        });
    }
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null &&
                ...
                TextUtils.isEmpty(weightString) && mGender == ProductContract.ProductEntry.GENDER_UNKNOWN) {
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PET_BREED, breedString);
        values.put(ProductContract.ProductEntry.COLUMN_PET_GENDER, mGender);
        ...
        values.put(ProductEntry.COLUMN_PET_WEIGHT, weight);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                ProductContract.ProductEntry.COLUMN_PET_GENDER,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int genderColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PET_GENDER);
            int weightColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PET_WEIGHT);
